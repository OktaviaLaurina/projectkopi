...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2021 at 03:50 PM
...
INSERT INTO `datakopi` (`id`, `namakopi`, `ketersediaan`, `harga`, `gambar`, `created_at`, `updated_at`) VALUES
(11, 'Liberary', '5', '23000', 'assets/gambar/RxRm8GnEDPPyOq6lAlJpQ0JFZjE3Y2WNZFuQR6bX.jpg', NULL, NULL),
(13, 'Arabica', '15', '40000', 'assets/gambar/vehpGD9GGBX4UQwGbG3R6IeCANHbq63KsXG6mipl.jpg', NULL, NULL);
...
CREATE TABLE `penjualan` (
  ...
  `kopi_id` bigint(20) UNSIGNED NOT NULL,
  `namakopi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `totalpenjualan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `totalpemasukan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, 'okta', 'okta@gmail.com', NULL, '$2y$10$50x6kVloZ7AJQIgj/lrJ/e68D0yhqOPV3Vz8xNb2gAFUc4f7BBPD2', NULL, '2021-07-01 04:52:58', '2021-07-01 04:52:58'),
...
ALTER TABLE `penjualan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `penjualan_kopi_id_foreign` (`kopi_id`);
...
--
ALTER TABLE `penjualan`
  ADD CONSTRAINT `penjualan_kopi_id_foreign` FOREIGN KEY (`kopi_id`) REFERENCES `kopi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
